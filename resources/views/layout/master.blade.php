    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Serba<sup>Ada</sup></div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/admin/users/">
                    ...
                    <span class="{{ $title == 'users' ? 'text-gray-900' : '' }}">Dashboard </span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/admin/categories">
                    ...
                    <span class="{{ $title == 'categories' ? 'text-gray-900' : '' }}">Categories</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/admin/products">
                    <i class="fas fa-fw fa-table"></i>
                    <span class="{{ $title == 'products' ? 'text-gray-900' : '' }}">Products</span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="/admin/sales">
                    <i class="fas fa-fw fa-table"></i>
                    <span class="{{ $title == 'sales' ? 'text-gray-900' : '' }}">Sales</span>
                </a>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"  src="{{ asset(auth()->user()->foto ? 'storage/'.auth()->user()->foto  : 'img/user.jpg') }}">
                            </a>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Table {{ $heading }}</h1>
